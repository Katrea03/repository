    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.bumenmingcheng"
              placeholder="部门名称"
              clearable
              :readonly="ro.bumenmingcheng"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.bumenzhuguan"
              placeholder="部门主管"
              clearable
              :readonly="ro.bumenzhuguan"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.bumenrenshu"
              placeholder="部门人数"
              clearable
              :readonly="ro.bumenrenshu"
            ></el-input>
          </el-form-item>
          <div v-else>
