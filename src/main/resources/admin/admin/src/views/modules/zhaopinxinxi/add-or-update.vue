    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.zhaopingangwei"
              placeholder="招聘岗位"
              clearable
              :readonly="ro.zhaopingangwei"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.zhaopinrenshu"
              placeholder="招聘人数"
              clearable
              :readonly="ro.zhaopinrenshu"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.luyongrenshu"
              placeholder="录用人数"
              clearable
              :readonly="ro.luyongrenshu"
            ></el-input>
          </el-form-item>
          <div v-else>
