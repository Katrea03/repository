      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '招聘岗位' : ''">
            <el-input
              ...
              v-model="searchForm.zhaopingangwei"
              placeholder="招聘岗位"
              clearable
            ></el-input>
            <el-input
        ...
        >
          <el-form-item>
            ...
            <el-button
              v-if="
                isAuth('zhaopinxinxi', '新增') && contents.btnAdAllIcon == 0
              "
              type="success"
              @click="addOrUpdateHandler()"
              >{{ contents.btnAdAllFont == 1 ? "新增" : "" }}</el-button
            ...
            <el-button
              v-if="
                isAuth('zhaopinxinxi', '报表') && contents.btnAdAllIcon == 0
              "
              type="warning"
              @click="chartDialog()"
              >{{ contents.btnAdAllFont == 1 ? "统计报表" : "" }}</el-button
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('zhaopinxinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('zhaopinxinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('zhaopinxinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
  ...
  methods: {
    ...
    chartDialog() {
      ...
      this.$nextTick(() => {
        ...
        var luyongrenshuChart = this.$echarts.init(
          document.getElementById("luyongrenshuChart"),
          "macarons"
        );
        this.$http({
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.zhaopingangwei != undefined
      ) {
