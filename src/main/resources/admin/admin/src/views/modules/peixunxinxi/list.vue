        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '培训项目' : ''">
            <el-input
              ...
              v-model="searchForm.peixunxiangmu"
              placeholder="培训项目"
              clearable
            ></el-input>
            <el-input
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('peixunxinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('peixunxinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('peixunxinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        this.searchForm.peixunxiangmu != "" &&
        this.searchForm.peixunxiangmu != undefined
      ) {
