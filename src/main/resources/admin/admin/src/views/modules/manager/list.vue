      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item>
            ...
            /></el-button>
            <el-button
              v-if="isAuth('manager', '新增') && contents.btnAdAllIcon == 0"
              type="success"
              @click="addOrUpdateHandler()"
              >{{ contents.btnAdAllFont == 1 ? "新增" : "" }}</el-button
            >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              /></el-button>
              <el-button
                v-if="isAuth('manager', '查看') && contents.tableBtnIcon == 0"
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
                >{{ contents.tableBtnFont == 1 ? "详情" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('manager', '修改') && contents.tableBtnIcon == 0"
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "修改" : "" }}</el-button
              ...
              /></el-button>
              <el-button
                v-if="isAuth('manager', '删除') && contents.tableBtnIcon == 0"
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
                >{{ contents.tableBtnFont == 1 ? "删除" : "" }}</el-button
