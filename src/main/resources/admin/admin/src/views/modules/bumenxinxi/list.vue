        ...
        >
          <el-form-item :label="contents.inputTitle == 1 ? '部门名称' : ''">
            <el-input
              ...
              v-model="searchForm.bumenmingcheng"
              placeholder="部门名称"
              clearable
            ></el-input>
            <el-input
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '部门主管' : ''">
            <el-input
              v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
              prefix-icon="el-icon-search"
              v-model="searchForm.bumenzhuguan"
              placeholder="部门主管"
              clearable
            ></el-input>
            <el-input
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                v-if="
                  isAuth('bumenxinxi', '查看') && contents.tableBtnIcon == 0
                "
                type="success"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id, 'info')"
              ...
              <el-button
                v-if="
                  isAuth('bumenxinxi', '修改') && contents.tableBtnIcon == 0
                "
                type="primary"
                size="mini"
                @click="addOrUpdateHandler(scope.row.id)"
              ...
              <el-button
                v-if="
                  isAuth('bumenxinxi', '删除') && contents.tableBtnIcon == 0
                "
                type="danger"
                size="mini"
                @click="deleteHandler(scope.row.id)"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        this.searchForm.bumenmingcheng != "" &&
        this.searchForm.bumenmingcheng != undefined
      ) {
        params["bumenmingcheng"] = "%" + this.searchForm.bumenmingcheng + "%";
      }
      if (
        this.searchForm.bumenzhuguan != "" &&
        this.searchForm.bumenzhuguan != undefined
      ) {
