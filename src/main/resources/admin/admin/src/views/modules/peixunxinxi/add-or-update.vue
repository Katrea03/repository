    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.peixunxiangmu"
              placeholder="培训项目"
              clearable
              :readonly="ro.peixunxiangmu"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.peixundidian"
              placeholder="培训地点"
              clearable
              :readonly="ro.peixundidian"
            ></el-input>
          </el-form-item>
          <div v-else>
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.peixunneirong = this.ruleForm.peixunneirong.replace(
            reg,
            "../../../springbootq731f/upload"
          );
        } else {
          this.$message.error(data.msg);
        }
