<template>
  <div class="main-content">
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                ...
                icon="el-icon-tickets"
                size="mini"
                @click="kaoqinxinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "考勤" : "" }}</el-button
              >
              <el-button
                v-if="
                  isAuth('yuangong', '考勤') &&
                ...
                size="mini"
                @click="kaoqinxinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "考勤" : ""
                }}<i class="el-icon-tickets el-icon--right"
              /></el-button>
              <el-button
                v-if="isAuth('yuangong', '考勤') && contents.tableBtnIcon == 0"
                type="success"
                size="mini"
                @click="kaoqinxinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "考勤" : "" }}</el-button
              ...
              <el-button
                ...
                icon="el-icon-tickets"
                size="mini"
                @click="gongzixinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "工资" : "" }}</el-button
              >
              <el-button
                v-if="
                  isAuth('yuangong', '工资') &&
                ...
                size="mini"
                @click="gongzixinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "工资" : ""
                }}<i class="el-icon-tickets el-icon--right"
              /></el-button>
              <el-button
                v-if="isAuth('yuangong', '工资') && contents.tableBtnIcon == 0"
                type="success"
                size="mini"
                @click="gongzixinxiCrossAddOrUpdateHandler(scope.row, 'cross')"
                >{{ contents.tableBtnFont == 1 ? "工资" : "" }}</el-button
    ...
    <kaoqinxinxi-cross-add-or-update
      v-if="kaoqinxinxiCrossAddOrUpdateFlag"
      :parent="this"
      ref="kaoqinxinxiCrossaddOrUpdate"
    ></kaoqinxinxi-cross-add-or-update>
    <gongzixinxi-cross-add-or-update
      v-if="gongzixinxiCrossAddOrUpdateFlag"
      :parent="this"
      ref="gongzixinxiCrossaddOrUpdate"
    ></gongzixinxi-cross-add-or-update>
  </div>
</template>
<script>
